  ...
  return (
    ...
    >
      ...
      <DialogContent id="scroll-terms-content" dividers onScroll={handleScroll}>
        <DialogContentText id="scroll-terms-description" tabIndex={-1}>
          <div>
            <b>
          ...
          <div>
            ...
            <a href="https://chatapp.usoncology.com">chatapp.usoncology.com</a>. McKesson’s ChatApp
            is provided to you for your convenience, to amplify productivity, and to expose you to
          ...
          <ol>
            <li>
              ...
              <strong>
                <u>
                  Protected Health Information (PHI), or other personal data (also known as
                  “personal information” or “personally identifiable information”) in ChatApp is
                  prohibited.
                </u>
              </strong>
            </li>
            ...
            <li>
              ...
              monitoring. In addition to continuous tracking and monitoring by security personnel,
              you are the first and best line of defense in keeping McKesson, USON, and your
              practice’s data, and that of its individual stakeholders, confidential and private.
            </li>
            <br />
            <li>
              ChatApp is not a replacement for humans or human judgment nor is it a substitute for
              exercising critical thinking. ChatApp is not and should not be used as a replacement
              for professional medical evaluation, advice, diagnosis, or treatment. ChatApp, similar
              to any artificial intelligence (AI) system, may hallucinate or produce unexpected
            ...
            <br />
            <li>
              You may not use, copy, modify, distribute, translate, reproduce, republish,
              disassemble, reverse engineer, decompile, mirror, frame, hyperlink or transmit any of
              the content or materials of McKesson’s ChatApp or rent or sell use of or access to
              (such as on a time share or service bureau basis) McKesson’s ChatApp, or any of the
              content or materials on McKesson’s ChatApp. You may not permit third parties to access
              McKesson’s ChatApp or use any McKesson ChatApp content.
            </li>
            <br />
            <li>
            ...
            <li>
              ...
              regarding your ability to access ChatApp. McKesson or its affiliates or vendor
              expressly disclaims any warranty of uptime or availability. McKesson or its affiliates
              (e.g., the U.S. Oncology Network) reserves the right to, without notice, change,
              modify, suspend or discontinue any Services or content available on or through ChatApp
              at any time without notice, or otherwise change specifications at any time.
            </li>
            <br />
            <li>
            ...
            <li>
              ...
              , constitute the agreement between you and the U.S. Oncology Network (“USON”)
              regarding access and/or use of McKesson’s ChatApp. BY ACCESSING OR USING MCKESSON’S
              CHATAPP, YOU AGREE TO BE BOUND BY AND ABIDE BY THESE TERMS AND CONDITIONS OF USE.
            </li>
          </ol>
        </DialogContentText>
      </DialogContent>
      <DialogActions>
        ...
        <Button disabled={acceptButtonDisabled} onClick={handleAccept}>
          Accept
        </Button>
      </DialogActions>
    </Dialog>
