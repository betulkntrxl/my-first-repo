...
const DrawerMenu = (props: {
  ...
  const Accordion = styled((propsAccordion: AccordionProps) => (
    <MuiAccordion disableGutters elevation={0} square {...propsAccordion} />
  ))(({ theme }) => ({
  ...
  const AccordionSummary = styled((propsAccordianSummary: AccordionSummaryProps) => (
    <MuiAccordionSummary
      style={{ flexGrow: 0 }}
      expandIcon={<ExpandMoreIcon sx={{ fontSize: '0.9rem' }} />}
      {...propsAccordianSummary}
    />
  ))(({ theme }) => ({
    backgroundColor:
